...
import br.com.diaristaslimpo.limpo.Controler.webservice.AlteraEndereco;
import br.com.diaristaslimpo.limpo.Controler.webservice.EnviaEndereco;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_enviar_endereco:
                ...
                final int idCliente = scriptSQL.retornaIdDiarista();
