 ...
 */
public class AlteraCadastro extends AsyncTask<String, Void, String> { // linha 22
    ...
    public AlteraCadastro(Context context) {
    ...
    protected void onPostExecute(String resposta) { // thread principal
        ...
        if (resposta == null) {
            dialog.dismiss();
            Intent it = new Intent(context, AlteraCadastro.class);
